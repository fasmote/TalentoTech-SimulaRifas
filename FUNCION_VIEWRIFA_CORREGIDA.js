// =====================================================================
// 🔧 FUNCIÓN VIEWRIFA CORREGIDA - COPY/PASTE EN index.html
// =====================================================================

// INSTRUCCIONES:
// 1. Abre: frontend/index.html
// 2. Busca la función: "async function viewRifa(rifaId) {"
// 3. Selecciona TODA la función (hasta su cierre con "}")
// 4. Reemplázala con el código de abajo
...
2. Busca (Ctrl+F): "async function viewRifa(rifaId) {"
3. Selecciona TODA la función desde "async function" hasta el "}" final
4. Copia todo el código de arriba y pégalo reemplazando la función actual
5. Guarda el archivo (Ctrl+S)
6. Recarga la página en el navegador (F5)
7. Prueba el botón "Ver" - ¡Debería funcionar!
